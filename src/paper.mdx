...
import HDPE from "./assets/output_video_HDPE.mp4";
import LDPE from "./assets/output_video_LDPE.mp4";
import PP from "./assets/output_video_PP.mp4";
import PS from "./assets/output_video_PS.mp4";
import PVC from "./assets/output_video_PVC.mp4";

<Video src={outside} />

## Videos of some measurements
<div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-6">
  ...
  <div class="xl:col-span-2 xl:col-start-4">
    <video
      class="w-full h-auto rounded-lg"
      src={PVC}
      controls
